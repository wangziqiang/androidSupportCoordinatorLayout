...
public class QuickReturnFooterBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public static String TAG ="QuickReturnFooterBehavior";
    ...
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, View child, View directTargetChild, View target, int nestedScrollAxes) {
        android.util.Log.e(TAG,"SCROLL_AXIS_HORIZONTAL 1 << 0 = "+(1 << 0));
        android.util.Log.e(TAG,"SCROLL_AXIS_VERTICAL 1 << 1 = "+(1 << 1));
        android.util.Log.e(TAG,"nestedScrollAxes = "+nestedScrollAxes);
        android.util.Log.e(TAG,"nestedScrollAxes & ViewCompat.SCROLL_AXIS_VERTICAL = "+(nestedScrollAxes & ViewCompat
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, View child, View target, int dx, int dy, int[] consumed) {
        ...
        android.util.Log.e(TAG," mDySinceDirectionChange = "+mDySinceDirectionChange);

        android.util.Log.e(TAG," child.getHeight() = "+child.getHeight()); // 193
